...
const generateAccessAndRefreshTokens = async(userId)=>{
  try {
    ...
    throw new ApiError(500, "Something went wwrong while generating refresh and accessToken")
  }
}
...
const refreshAccessToken = asuncHandler(async(req,res)=>{
